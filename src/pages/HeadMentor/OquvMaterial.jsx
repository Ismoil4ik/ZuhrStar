				...
				<div className='max-w-7xl mx-auto'>
					...
					{dataLoading ? (
						<div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8'>
							{[...Array(6)].map((_, i) => (
								<div key={i} className='bg-white rounded-2xl shadow-lg p-6 border-2 border-transparent'>
									...
									<div className='h-9 bg-gray-200 rounded-xl animate-pulse w-full' />
								</div>
							))}
						</div>
					) : !accessToken ? (
