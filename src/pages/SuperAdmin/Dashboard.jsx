...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        const res = await axios.get("https://zuhr-star-production.up.railway.app/api/users", {
  ...
  useEffect(() => {
    ...
    const fetchTeachers = async () => {
      try {
        const res = await axios.get("https://zuhr-star-production.up.railway.app/api/teachers", {
          headers: { Authorization: `Bearer ${accessToken}` },
          signal: controller.signal
        });
  ...
  useEffect(() => {
    ...
    const fetchChecks = async () => {
      try {
        const res = await axios.get("https://zuhr-star-production.up.railway.app/api/checks", {
          headers: { Authorization: `Bearer ${accessToken}` },
          signal: controller.signal
        });
        ...
        await Promise.allSettled(
          studentIds.map(async (studentId) => {
            try {
              const studentRes = await axios.get(`https://zuhr-star-production.up.railway.app/api/students/${studentId}`, {
                headers: { Authorization: `Bearer ${accessToken}` },
                signal: controller.signal
              });
  ...
  useEffect(() => {
    if (!accessToken) return;
    const controller = new AbortController();
    axios.get('https://zuhr-star-production.up.railway.app/api/students', {
      headers: { Authorization: `Bearer ${accessToken}` },
      signal: controller.signal,
    })
      .then(res => {
  ...
  useEffect(() => {
    if (!accessToken) return;
    const controller = new AbortController();
    axios.get('https://zuhr-star-production.up.railway.app/api/groups', {
      headers: { Authorization: `Bearer ${accessToken}` },
      signal: controller.signal,
    })
      .then(res => {
  ...
  useEffect(() => {
    if (!accessToken) return;
    const controller = new AbortController();
    axios.get('https://zuhr-star-production.up.railway.app/api/courses', {
      headers: { Authorization: `Bearer ${accessToken}` },
      signal: controller.signal,
    })
      .then(res => {
